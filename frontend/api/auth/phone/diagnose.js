...
export default async function handler(req, res) {
  ...
  try {
    ...
    return sendJson(res, {
      success: sms.configured && Boolean(env.phoneAuthSecret) && Boolean(env.insforgeUrl && env.insforgeAnonKey),
    ...
    console.error('[Phone OTP Diagnosis Failed]', err?.message || err);
