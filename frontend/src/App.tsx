...
const AppContent: React.FC = () => {
  ...
  </Routes>{currentUser && <><PlatformEnhancements /><ProfessionalLayer /></>}</main>{!isChat && <Footer />}<MobileBottomNav /></div>;
};
