...
import { InvitePeersPage } from './pages/InvitePeersPage';
...
const ProfileIntegratedRoute: React.FC = () => { const { id = '' } = useParams(); return profileScreenIds.has(id) ? <AdditionalScreen /> : <LinkedInStyleProfilePage />; };
