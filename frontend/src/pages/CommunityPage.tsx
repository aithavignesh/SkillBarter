...
export const CommunityPage: React.FC = () => {
  ...
  return <AppPageShell eyebrow="Student community" title="Learn together. Share what you know." description="A live view of peer learning activity, useful skills and exchanges across the SkillBarter network." icon={<Compass className="h-3.5 w-3.5" />} actions={<Link to="/connections"><Button size="sm">View connections</Button></Link>}>
    ...
    <div className="mt-5 grid gap-px border border-[#e1e4e8] bg-[#e1e4e8] md:grid-cols-3">
      ...
      <section className="bg-white p-6"><Sparkles className="h-5 w-5 text-[#d31d24]" /><h2 className="mt-3 font-bold text-[#17233b]">Run a learning session</h2><p className="mt-1 text-sm leading-6 text-slate-500">Turn your expertise into a practical workshop or peer-learning session.</p><Link to="/workshops/create-workshop"><Button className="mt-4" size="sm">Create workshop</Button></Link></section>
