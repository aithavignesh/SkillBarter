...
const labelFor=(type:string)=>{const map:any={MESSAGE:'Message',EXCHANGE_ACCEPTED:'Exchange accepted',EXCHANGE_REJECTED:'Exchange declined',EXCHANGE_WITHDRAWN:'Exchange withdrawn',EXCHANGE_CANCELLED:'Exchange cancelled',EXCHANGE_COMPLETED:'Exchange completed',EXCHANGE_COMPLETION_PENDING:'Completion confirmed',EXCHANGE_SCHEDULE_UPDATED:'Schedule updated',CONNECTION_REQUEST:'Connection request',CONNECTION_ACCEPTED:'Connection accepted',TRUST_REVIEW:'New review',REVIEW:'New review'};return map[type]||'Activity';};
