    ...
    >
      ...
      {loading ? (
        ...
        <Card className="border-[#e1e4e8] bg-white p-14 text-center">
          ...
          <p className="mx-auto mt-1 max-w-md text-sm text-slate-500">{activeTab === 'REQUESTS' ? 'New connection requests will appear here.' : 'Discover nearby people, connect with them and build your barter circle.'}</p>
        </Card>
      ) : (
