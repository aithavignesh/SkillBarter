  ...
  return (
    ...
    >
      ...
      {loading ? (
        ...
        <div className="mt-5 border border-[#e1e4e8] bg-white py-20 text-center"><Repeat className="mx-auto h-9 w-9 text-slate-300" /><h3 className="mt-3 text-sm font-bold text-[#17233b]">No exchanges in this view</h3><p className="mt-1 text-xs text-slate-500">Find a peer who can teach what you want to learn and start your first exchange.</p><Link to="/discover" className="mt-4 inline-block"><Button size="sm">Find learning partners</Button></Link></div>
      ) : (
