...
import { LayoutGrid, ChevronDown, UserRound, Compass, ArrowLeftRight, Bell, MessageSquare, Users, GraduationCap, Coins, ShieldCheck, LifeBuoy, Settings, Activity } from 'lucide-react';
